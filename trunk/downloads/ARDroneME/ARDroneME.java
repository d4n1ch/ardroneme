/* ARDroneME --- J2ME based AR.Drone Controller
Author: MAPGPS at
...
Speed(%) slider: change rudder rate in range of 5%~90%
...
Arrow buttons with central button pressed:
        Go Forward
            ^
            |
Go Left <--- ---> Go Right
